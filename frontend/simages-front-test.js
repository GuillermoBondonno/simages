...
function generateNDVIImage() {
    ...
    document.getElementById("NDVIImage").src = "https://cutewallpaper.org/21/loading-gif-transparent-background/Animated-Loading-Bar-Gif-Transparent-Background.gif";
    ...
    //read the headers and display the numeric index
    //set the src of the img (placeholder at first) to the same localhost url (hopefully cached) 
};
/*let headers = xhr
